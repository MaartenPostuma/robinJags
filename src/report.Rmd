...
for(i in 1:nrow(parameters)){
  ...
  modelOut <- readRDS(paste0(args[1],"output/Order~",dataSub$Order,"/Variable~",dataSub$Variable,".Rds"))
  summaryOut <- as.data.frame(modelOut$BUGSoutput$summary)
  summaryOut$sign<-""
  summaryOut$sign[summaryOut$mean<summaryOut$`2.5%`|summaryOut$mean>summaryOut$`97.5%`]<-"*"
  ...
  if(dataOut$value<summaryOut$`2.5%`[32]|dataOut$value>summaryOut$`97.5%`[32]){
...
data.table(oneBigTable[c("Order","Variable","signVar","value","hedgerow","flowerstrip","JulianDay","JulianDay2","temperature")],filter="top")
